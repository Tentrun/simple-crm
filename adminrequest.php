...
$requests = R::getAll("SELECT * FROM `request` ORDER BY id DESC");
...
echo '</div>';
echo '<div class="cell">';
echo $item['typeproblem'];
echo '</div>';
echo '<div class="cell"><div id="squaremsg">';
echo $item['textrequest'];
echo '</div></div>';
echo '<div class="cell">';
echo $item['user'];
echo '</div>';
...
?>
  ...
  <div class ="leftpanel"> 
        <div class="items">
          <img src="../images/cart.png" ondragstart="return false;" onclick="javascript:document.location.href='/adminpanel.php'"> <center><div id="itemstext" onclick="javascript:document.location.href='/adminpanel.php'">Все заказы</div></center> 
